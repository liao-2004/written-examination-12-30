...
<template>
  <div class="box">
    <div class="div-text">
      <div class="text">
        <span class="text-span1">Finish!</span>
        <br>
        <span class="text-span1">Upload your resume</span>
        <br>
    ...
    <div class="div-img">
      <img src="../public/f3b98a45b95147719af263d1e992460c384c379e.png" alt="">
    </div>
    <div class="div-box">
...
<style scoped>
  ...
  .div-button{
    ...
    div{
      ...
      height: 67px;
      border-radius: 8px;
      background-color: rgba(117,172,255,1);
      line-height: 67px;
      font-weight: 400;
      font-size: 24px;
      letter-spacing: 8%;
